<?php
/*
Plugin Name: Easydevtuts Accordion
...
function add_accordion_tinymce_plugin($plugin_array) {
   $plugin_array['youraccordion'] = plugins_url( $path = 'easydevtuts-accordion/editor_plugin.js', $plugin = 'easy-accordion' );
   return $plugin_array;
}
...
if(!is_admin()){
  //register style
  wp_register_style( 'bootstrap-accordion-styles', plugins_url().'/easydevtuts-accordion/css/bootstrap-accordion.min.css' );

  //load style
  wp_enqueue_style('bootstrap-accordion-styles',plugins_url().'/easydevtuts-accordion/css/bootstrap-accordion.min.css');
  ...
  //register script
  wp_register_script( 'bootstrap-accordion-scripts', plugins_url().'/easydevtuts-accordion/js/bootstrap-accordion.min.js', array(), '1.0', true);

  //load script
  wp_enqueue_script('bootstrap-accordion-scripts',plugins_url().'/easydevtuts-accordion/js/bootstrap-accordion.min.js');
}